        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><center>Ajouter nouveau modele</center> </h4>              
              <form class="form-horizontal style-form" method="post" action="{{ route ('modele.update', ['id'=>$modeles->id]) }}" enctype="multipart/form-data">
              {{ csrf_field() }}
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Nom modele</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nomModele" value="{{ $modeles->nomModele}}">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="montantDeOperation" value="{{ $modeles->montantDeOperation}}">
                ...
                <div class="form-group">
                  ...
                  <select name="construction_id" id="construction_id" class="form-control">
                           ...
                           @foreach($types as $type)
                             @if( $type->id == $modeles->construction_id)
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-10">
                    <input type="file" class="form-control" accept="image/*" value="{{ $modeles->imageIllustration}}" name="imageIllustration" id="file" onchange="loadFile(event)" style="display:none;">
                    ...
                    <div style="display: inline-block;
                            ...
                            "> 
                            <p><img id="output" width="150" src="{{asset('uploads/modeles/'.$modeles->imageIllustration)}}"/></p>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="descriptionModele" value="{{ $modeles->descriptionModele}}">
