...
@section('content')
 ...
 <section id="main-content">
      ...
      <h3><a href="{{route('home')}}" style="color:#797979;">Accueil</a>  
        ...
        <i class="fa fa-angle-right"></i><a href="" style="color:#797979;">Ajout réalisation</a></h3>
        
        <div class="row mt">          
          <div class="col-lg-12 mt">
            <div class="row content-panel">
            <h4 class="mb"><center>Ajout une nouvelle réalisation</center> </h4>
              ...
              <!-- /panel-heading -->
              <form class="form-horizontal style-form" method="post" action="{{ route('realisation.Action')}}" enctype="multipart/form-data">
                  {{ csrf_field() }}              
                  ...
                  {{ csrf_field() }} 
                    <div class="row">  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="nomRealisation" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="number" class="form-control" name="montantRealisation">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                <input type="file" class="form-control" accept="image/*" name="imageRealisation" id="file" onchange="loadFile(event)" style="display:none;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <textarea type="text" class="form-control" name="descriptionRealisation" rows="5" cols="30"></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <a data-toggle="tab" href="#contact" class="contact-map">
                            <button class="btn btn-theme">Suivant</button></a>
                  ...
                  <div id="contact" class="tab-pane">
                    ...
                    <div class="col-lg-8 col-lg-offset-2 detailed">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="societeColaborateur" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="maitreOuvrage" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="architecte" >
                        ...
                        <div class="form-group">
                            <div class="col-lg-offset-3 col-lg-10">
                              <a data-toggle="tab" href="#overview" class="contact-map">
                              <button class="btn btn-theme04" >Retour</button></a>
                              <a data-toggle="tab" href="#edit" class="contact-map">
                              <button class="btn btn-theme" >Suivant</button></a>                                 
                            </div>
                          </div>                        
                    </div> 
                    ...
                    <div class="col-lg-8 col-lg-offset-2 detailed">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                ...
                                <span class="help-block">Cet champ est facultatif *.</span>
