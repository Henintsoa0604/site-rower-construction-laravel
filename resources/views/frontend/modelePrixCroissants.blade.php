 ...
 <section id="breadcrumbs" class="breadcrumbs">
    ...
    <section id="pricing" class="pricing">    
      <div class="container">
        ...
        @foreach($prixcroisante as $prixcroisantes)
        
          <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
            <div class="box">
              <span class="advanced">Modele3D</span>
              <img src="{{asset('uploads/modeles/'.$prixcroisantes->imageIllustration)}}" alt="" height="200" width="310">
              <?php
														$number =  $prixcroisantes->montantDeOperation;
              ...
              <div class="btn-wrap">
                <a href="{{route('modele.detail', ['id'=>$prixcroisantes->id])}}" class="btn-buy">Voir le detail</a>
              </div>
            </div>
            <br><br>
          </div>
