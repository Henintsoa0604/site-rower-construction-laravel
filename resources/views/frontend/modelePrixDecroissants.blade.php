...
<main id="main">
 ...
 <section id="breadcrumbs" class="breadcrumbs">
    ...
    <h4 style="margin-left:10%;font-family: 'Open Sans', sans-serif;"> 
      ...
      <a href="">Prix decroissante</a>
    </h4>
    </div>
    <br>
    <h1 class="portfolio-title" style="margin-left:25%;color:#d9232d;">Ces modèles peuvent vous intéresser</h1><br>
    ...
    <section id="pricing" class="pricing">    
      <div class="container">
        ...
        @foreach($prixdecroisante as $prixdecroisantes)
        
          <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
            <div class="box">
              <span class="advanced">Modele3D</span>
              <img src="{{asset('uploads/modeles/'.$prixdecroisantes->imageIllustration)}}" alt="" height="200" width="310">
              <?php
														$number =  $prixdecroisantes->montantDeOperation;
              ...
              <div class="btn-wrap">
                <a href="{{route('modele.detail', ['id'=>$prixdecroisantes->id])}}" class="btn-buy">Voir le detail</a>
              </div>
            </div>
            <br><br>
          </div>
